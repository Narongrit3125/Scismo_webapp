...
export default function PageLayout({ 
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Page Header */}
      {title && (
        <div className="bg-gradient-to-r from-yellow-400 via-amber-400 to-yellow-500 py-12">
            ...
            <div className="lg:col-span-1">
              <div className="space-y-6 sticky top-4">
                ...
                <div className="bg-yellow-500 text-white rounded-lg overflow-hidden shadow-md">
                  <div className="px-6 py-3 bg-yellow-600">
                    <h3 className="text-lg font-semibold">เมนูย่อย</h3>
                  </div>
                  <div className="p-4">
                    <ul className="space-y-3">
                      <li>
                        <a href="/about/history" className="flex items-center text-white hover:text-yellow-100 transition-colors">
                          <span className="w-2 h-2 bg-white rounded-full mr-3"></span>
                          ประวัติสโมสร
                        </a>
                      </li>
                      <li>
                        <a href="/about/organization" className="flex items-center text-white hover:text-yellow-100 transition-colors">
                          <span className="w-2 h-2 bg-white rounded-full mr-3"></span>
                          โครงสร้างองค์กร
                        </a>
                      </li>
                      <li>
                        <a href="/members" className="flex items-center text-white hover:text-yellow-100 transition-colors">
                          <span className="w-2 h-2 bg-white rounded-full mr-3"></span>
                          สมาชิกสโมสร
                        </a>
                      </li>
                      ...
                      <li>
                        <a href="/news" className="flex items-center text-white hover:text-yellow-100 transition-colors">
                          <span className="w-2 h-2 bg-white rounded-full mr-3"></span>
                          ข่าวสาร
                        </a>
                      </li>
                      <li>
                        <a href="/activities" className="flex items-center text-white hover:text-yellow-100 transition-colors">
                          <span className="w-2 h-2 bg-white rounded-full mr-3"></span>
                          กิจกรรม
                        </a>
                      </li>
                      <li>
                        <a href="/documents" className="flex items-center text-white hover:text-yellow-100 transition-colors">
                          <span className="w-2 h-2 bg-white rounded-full mr-3"></span>
                          เอกสาร
                        </a>
                      </li>
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                  <div className="px-6 py-3 bg-gradient-to-r from-yellow-500 to-amber-500">
                ...
                {/* Banner */}
                <div className="bg-gradient-to-br from-yellow-400 via-amber-400 to-yellow-500 rounded-lg p-6 text-center shadow-md">
